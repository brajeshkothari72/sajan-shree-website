...
function GalleryPage() {
  return (
    <>
      <SEO
        title="Uniform Product Gallery"
        description="View product categories from Sajan Shree Garments in Indore, including school uniforms, blazers, pants, aprons, security uniforms, corporate uniforms, and custom garments."
        path="/gallery"
      />
        ...
        <section className="relative overflow-hidden py-24 lg:py-32">
          <div className="absolute inset-0 z-0">
            <img
              ...
              alt="Sajan Shree Garments uniform product gallery"
